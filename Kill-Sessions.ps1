...
#Get-VISession | Where { $_.IdleMinutes -gt 25 } | Disconnect-ViSession
Get-VISession | Where  { $_.Username -notlike "ADS\rsadmin" -and $_.Username -notlike "ADS\bradmin"} |
Where { $_.IdleMinutes -gt 180 } | Disconnect-ViSession
